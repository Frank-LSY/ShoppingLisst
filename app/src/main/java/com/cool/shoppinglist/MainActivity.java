...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plus = findViewById(R.id.ibn_add1);
        minus = findViewById(R.id.ibn_del1);
    ...
    private void initCtrl()
    {
        ...
        scroll = (ScrollView) this.findViewById(R.id.scrollView3);
...
//                addContent(v);
    ...
    private void addContent(final View v, String currentNum, String currentText) {
        ...
        if (iIndex >= 0) {
            ...
            // 2.创建内部TextView控件
            final TextView tvContent = new TextView(MainActivity.this);
            ...
            //创建 添加数目
            final TextView et = new TextView(MainActivity.this);
